...
//Sum and Average
    ...
    double average0=0.0,average1=0.0,average2=0.0,average3=0.0,average4=0.0,average5=0.0;
//Getting the Sum
...
//Output Layout
    ...
    System.out.println((average0 + average1 + average2 + average3 + average4 + average5)/6);//calculating the Total Average
    System.out.println("----------------------------------------------------");
